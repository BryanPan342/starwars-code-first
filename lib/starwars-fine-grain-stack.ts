...
import * as schema from './fine-grain-implementation/index';
import { ObjectType } from '@aws-cdk/aws-appsync';

export class StarwarsCodeFirstFineGrainStack extends cdk.Stack {
  ...
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    writeFile('generated.fine-grain.graphql', this.api.schema.definition, (err) =>{
      if (err) throw err;
    });
  }
